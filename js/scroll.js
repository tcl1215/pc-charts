...
$(document).ready(function(){
    ...
    $('.page2 .info-box').slide({mainCell:".bd ul",autoPage:true,effect:"top",autoPlay:true,vis:5});
    
    $('.page3 .info-box').slide({mainCell:".bd2 ul",autoPage:true,effect:"top",autoPlay:true,vis:5});
